...
public class PuzzleMotherCubeController : MonoBehaviour // this was used to create all the transform points that a puzzle piece can attach to. It is not an active script in the scene. 
{
